  ...
  return(
      <div style={{display: props.display?'': 'none'}}>
        <div className="Page35NodeDes" id="Page35NodeDes1">
          ...
          <div className="NodeDesContent" id="Page35NodeTerm1"> 任期: 1</div>
        ...
        <div className="Page35NodeDes" id="Page35NodeDes2">
          ...
          <div className="NodeDesContent" id="Page35NodeTerm2"> 任期: 1</div>
        ...
        <div className="Page35NodeDes" id="Page35NodeDes3">
          ...
          <div className="NodeDesContent" id="Page35NodeTerm3"> 任期: 1</div>
        ...
        <div className="Page35Text" id="Page35Text1"> リーダーが選出されたら、システムへのすべての変更をすべてのノードに複製する必要があります。</div>
        <div className="Page35Text" id="Page35Text2"> これは、ハートビートに使用されたのと同じエントリ追加メッセージを使用して行われます。</div>
        <div className="Page35Text" id="Page35Text3"> プロセスを順を追って見ていきましょう。</div>
      </div>
  );
}
